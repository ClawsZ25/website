...
for(i=0; i < titles.length; i++){
      // make sure to add a <td> tage for images on EXAM 1
      htmlCode += `<tr><td><a href=${links[i]}>${titles[i]}</a></td><td>${summaries[i]}</td><td>${ratings[i]}</td></tr>`
       // add this after ratings for exam tommorow <td>${AddPicture(ratings[i])}</td>
}

//reference the first element in the tags
tableBody = document.getElementsByTagName("tbody")[0];

tableBody.innerHTML = htmlCode;

// function AddPicture(rating){
//       let picture = "Rotten_Tomatoes_1.png";
//       if(rating >= 8){
//             picture = "Rotten_Tomatoes_4.png";
//       } else if(rating >= 6){
//             picture = "Rotten_Tomatoes_3.png";
//       } else if(rating >= 4){
//             picture = "Rotten_Tomatoes_2.png";

//       } else {
//             picture = "Rotten_Tomatoes_1.png";
//       }

//       // create and return the <img> element
//       return `<img src = "${picture}" alt="Rating Picture"`;

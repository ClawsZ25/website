...
function wordCloud(sourceText) {
      ...
      sourceText = sourceText.replace(alphaRegx, ""); // replace characters with an empty string
      ...
      //creating a 2Darray
      let unique = [ [words[0], 1] ]; // intialize with first and count 1
      let uniqueIndex = 0;
      ...
      console.log(unique);
      //sort by how often a word appears
